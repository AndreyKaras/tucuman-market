...
Остальной контекст загружай по области задачи:

- `PROJECT_BRIEF.md` — продуктовая область и требования;
- `ARCHITECTURE.md` — границы модулей, backend, данные и интеграции;
- `DESIGN.md` — только визуальные и UI-задачи;
- `docs/ROADMAP.md` — планирование и статус этапов;
- остальные файлы из `docs/` — только когда задача их затрагивает.
