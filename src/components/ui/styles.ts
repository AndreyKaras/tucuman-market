...
export const containerClass = 'mx-auto w-full max-w-[1280px] px-4 sm:px-6 min-[900px]:px-8';
...
export const dangerIconButtonClass = cn(iconButtonClass, 'hover:border-danger hover:text-danger');
...
export const badgeBaseClass = 'rounded-sm px-2 py-1 text-[11px] leading-[1.2] font-bold';
export const saleBadgeClass = cn(badgeBaseClass, 'bg-accent-700 text-white');
export const warningBadgeClass = cn(badgeBaseClass, 'bg-accent-100 text-[#7c3500]');
