...
export function addRecentSearch(searches: readonly string[], value: string, locale: StoreLocale) {
  ...
  return [
    query,
    ...searches.filter((search) => search.toLocaleLowerCase(locale) !== normalized),
  ].slice(0, MAX_RECENT_SEARCHES);
}
